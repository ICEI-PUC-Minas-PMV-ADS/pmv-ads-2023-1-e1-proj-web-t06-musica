...
| Músico/Banda | Divulgar a qualidade do meu trabalho a partir dos shows que já fiz mediante a opinião de quem já o contratou. | Para aumentar as chances de ser contratado e também melhorar a remuneração do cachê.|

...
**Atualização do Board do GitHub (Kanban) com as funções para cada membro do grupo 12/04**:
...
**Como base para o Desenvolvimento das nossas páginas utilizamos o Tutorial "Desenvolvimento Web Front-End" produzido pelo prof. Marcos Kutova, disponível no YouTube:**
...
**Atualização do Board do GitHub (Kanban) com as atividades concluídas de cada membro no dia 09/05**:
...
![image](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2023-1-e1-proj-web-t06-musica/assets/126628545/4d06a14a-8a4b-4725-8ac6-8a4edd3071e8)
...
**Board Atualizado com os Issues e Milestones concluídos da Etapa 04 no dia 11/06:**
